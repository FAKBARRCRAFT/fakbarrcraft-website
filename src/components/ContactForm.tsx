			...
			<Container>
						...
						className='mx-auto grid max-w-screen-md gap-4 sm:grid-cols-2'>
							...
							<div className='flex items-center justify-between sm:col-span-2'>
								<button className='inline-block rounded-lg bg-[#161616] px-8 py-3 text-center text-sm font-semibold text-white outline-none transition duration-100 hover:scale-105 focus-visible:ring md:text-base'>
									Send
								</button>
